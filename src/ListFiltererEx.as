...
public class ListFiltererEx extends ListFilterer {
    ...
    override public function EntryMatchesFilter(param1:Object):Boolean {
        ...
        if (this.extraFilterType == -1) {
            return param1 != null && (!param1.hasOwnProperty("filterFlag") || (param1.filterFlag
                    & this.itemFilter) != 0);
        }
        if (param1 == null || param1.hasOwnProperty("filterFlag") && (param1.filterFlag
                & this.itemFilter) == 0) {
            return false;
        }
        ...
        switch (this.extraFilterType) {
            ...
            case FILTER_APPAREL_ARMOR_LEG_R:
                ...
                if (!this.isOutfit(_loc2_) && this.occupiesApparelSlot(_loc3_, this.extraFilterType,
                        true)) {
                    return true;
                }
                break;
    ...
    private function occupiesApparelSlot(param1:Array, param2:uint,
