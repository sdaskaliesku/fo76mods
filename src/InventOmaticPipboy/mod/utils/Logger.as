...
public class Logger {
    ...
    public static function init(debuggerTextField:TextField):void {
        // noinspection JSValidateTypes
        INSTANCE = new Logger(debuggerTextField);
        INSTANCE.info("###### INIT ######")
    }

    public function Logger(debuggerTextField:TextField) {
        this._debugger = debuggerTextField;
