...
package Shared.AS3
{
   ...
   public class BCGridList extends MovieClip
   {
      ...
      public static const TEXT_OPTION_NONE:String = // method body index: 1078 method index: 1078
      "None";
      
      public static const TEXT_OPTION_SHRINK_TO_FIT:String = // method body index: 1078 method index: 1078
      "Shrink To Fit";
      
      public static const TEXT_OPTION_MULTILINE:String = // method body index: 1078 method index: 1078
      "Multi-Line";
      
      public static const SELECTION_CHANGE:String = // method body index: 1078 method index: 1078
      "BCGridList::selectionChange";
      
      public static const ITEM_PRESS:String = // method body index: 1078 method index: 1078
      "BCGridList::itemPress";
      
      public static const LIST_PRESS:String = // method body index: 1078 method index: 1078
      "BCGridList::listPress";
      
      public static const MOUSE_OVER_ITEM:String = // method body index: 1078 method index: 1078
      "BCGridList::mouseOverItem";
      
      public static const LIST_UPDATED:String = // method body index: 1078 method index: 1078
      "BCGridList::listUpdated";
      
      public static const SELECTION_EDGE_BOUNCE:String = // method body index: 1078 method index: 1078
      "BCGridList::selectionEdgeBounce";
      
      public static const ITEM_CLICKED:String = // method body index: 1078 method index: 1078
      ...
      {
         // method body index: 1113 method index: 1113
         if(aIndex > 0)
         {
      ...
      {
         // method body index: 1114 method index: 1114
         if(!this.m_IsDirty)
         {
      ...
      {
         // method body index: 1115 method index: 1115
      ...
      {
         // method body index: 1120 method index: 1120
      ...
      {
         // method body index: 1121 method index: 1121
      ...
      {
         // method body index: 1125 method index: 1125
      ...
      {
         // method body index: 1126 method index: 1126
      ...
      private function onAddedToStage(e:Event) : void
      {
         ...
         if(this.ScrollUp_mc != null)
         {
            this.ScrollUp_mc.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):// method body index: 1128 method index: 1128
            *
            {
         ...
         if(this.ScrollDown_mc != null)
         {
            this.ScrollDown_mc.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):// method body index: 1129 method index: 1129
            *
            {
               // method body index: 1129 method index: 1129
               scrollRow(true);
            });
         }
         if(this.ScrollLeft_mc != null)
         {
            this.ScrollLeft_mc.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):// method body index: 1130 method index: 1130
            *
            {
               // method body index: 1130 method index: 1130
               scrollCol(false);
            });
         }
         if(this.ScrollRight_mc != null)
         {
            this.ScrollRight_mc.addEventListener(MouseEvent.CLICK,function(e:MouseEvent):// method body index: 1131 method index: 1131
            *
            {
