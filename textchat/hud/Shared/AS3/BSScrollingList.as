...
package Shared.AS3
{
   ...
   public class BSScrollingList extends MovieClip
   {
      ...
      public static const TEXT_OPTION_NONE:String = // method body index: 2422 method index: 2422
      "None";
      
      public static const TEXT_OPTION_SHRINK_TO_FIT:String = // method body index: 2422 method index: 2422
      "Shrink To Fit";
      
      public static const TEXT_OPTION_MULTILINE:String = // method body index: 2422 method index: 2422
      "Multi-Line";
      
      public static const MOUSEWHEEL_SCROLL_DISTANCE_CTRLSHIFT:uint = // method body index: 2422 method index: 2422
      9;
      
      public static const MOUSEWHEEL_SCROLL_DISTANCE_CTRL:uint = // method body index: 2422 method index: 2422
      6;
      
      public static const MOUSEWHEEL_SCROLL_DISTANCE_SHIFT:uint = // method body index: 2422 method index: 2422
      3;
      
      public static const MOUSEWHEEL_SCROLL_DISTANCE_BASE:uint = // method body index: 2422 method index: 2422
      1;
      
      public static const SELECTION_CHANGE:String = // method body index: 2422 method index: 2422
      "BSScrollingList::selectionChange";
      
      public static const ITEM_PRESS:String = // method body index: 2422 method index: 2422
      "BSScrollingList::itemPress";
      
      public static const LIST_PRESS:String = // method body index: 2422 method index: 2422
      "BSScrollingList::listPress";
      
      public static const LIST_ITEMS_CREATED:String = // method body index: 2422 method index: 2422
      "BSScrollingList::listItemsCreated";
      
      public static const PLAY_FOCUS_SOUND:String = // method body index: 2422 method index: 2422
      "BSScrollingList::playFocusSound";
      
      public static const MOBILE_ITEM_PRESS:String = // method body index: 2422 method index: 2422
      ...
      {
         // method body index: 2425 method index: 2425
         if(this.needMobileScrollList)
         {
      ...
      {
         // method body index: 2426 method index: 2426
      ...
      {
         // method body index: 2433 method index: 2433
      ...
      {
         // method body index: 2434 method index: 2434
         var _loc2_:* = undefined;
      ...
      {
         // method body index: 2450 method index: 2450
         return this.fShownItemsHeight;
      }
      
      protected function doSetSelectedIndex(param1:int) : *
      {
         // method body index: 2451 method index: 2451
         var _loc2_:int = 0;
         var _loc3_:BSScrollingListEntry = null;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
      ...
      {
         // method body index: 2483 method index: 2483
         this.iSelectedIndex = this._filterer.ClampIndex(this.iSelectedIndex);
         this.CalculateMaxScrollPosition();
      }
      ...
      {
         // method body index: 2484 method index: 2484
