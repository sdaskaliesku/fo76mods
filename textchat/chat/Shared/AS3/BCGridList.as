...
package Shared.AS3
{
   ...
   public class BCGridList extends MovieClip
   {
      ...
      public static const TEXT_OPTION_NONE:String = // method body index: 416 method index: 416
      "None";
      
      public static const TEXT_OPTION_SHRINK_TO_FIT:String = // method body index: 416 method index: 416
      "Shrink To Fit";
      
      public static const TEXT_OPTION_MULTILINE:String = // method body index: 416 method index: 416
      "Multi-Line";
      
      public static const SELECTION_CHANGE:String = // method body index: 416 method index: 416
      "BCGridList::selectionChange";
      
      public static const ITEM_PRESS:String = // method body index: 416 method index: 416
      "BCGridList::itemPress";
      
      public static const LIST_PRESS:String = // method body index: 416 method index: 416
      "BCGridList::listPress";
      
      public static const MOUSE_OVER_ITEM:String = // method body index: 416 method index: 416
      "BCGridList::mouseOverItem";
      
      public static const LIST_UPDATED:String = // method body index: 416 method index: 416
      "BCGridList::listUpdated";
      
      public static const SELECTION_EDGE_BOUNCE:String = // method body index: 416 method index: 416
      "BCGridList::selectionEdgeBounce";
      
      public static const ITEM_CLICKED:String = // method body index: 416 method index: 416
      ...
      private function onAddedToStage(param1:Event) : void
      {
         ...
         if(this.ScrollUp_mc != null)
         {
            this.ScrollUp_mc.addEventListener(MouseEvent.CLICK,function(param1:MouseEvent):// method body index: 466 method index: 466
            *
            {
         ...
         if(this.ScrollDown_mc != null)
         {
            this.ScrollDown_mc.addEventListener(MouseEvent.CLICK,function(param1:MouseEvent):// method body index: 467 method index: 467
            *
            {
         ...
         if(this.ScrollLeft_mc != null)
         {
            this.ScrollLeft_mc.addEventListener(MouseEvent.CLICK,function(param1:MouseEvent):// method body index: 468 method index: 468
            *
            {
         ...
         if(this.ScrollRight_mc != null)
         {
            this.ScrollRight_mc.addEventListener(MouseEvent.CLICK,function(param1:MouseEvent):// method body index: 469 method index: 469
            *
            {
