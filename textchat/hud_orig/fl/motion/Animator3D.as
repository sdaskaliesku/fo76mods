...
package fl.motion
{
   ...
   public class Animator3D extends AnimatorBase
   {
      ...
      private static var IDENTITY_MATRIX:Matrix = // method body index: 756 method index: 756
      new Matrix();
      
      protected static const EPSILON:Number = // method body index: 756 method index: 756
      1.0e-8;
